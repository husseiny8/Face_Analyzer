...
def predict_image(image_path):
    ...
    gender_probability = outputs["gender_probability"].squeeze().item()
    ...
    print()
    print(f"Gender : {GENDER_LABELS[gender_index]}")
    print(f"Probability : {gender_confidence:.2f}%")
    print()
    print(f"Age : {AGE_LABELS[age_index]}")
    print(f"Probability : {age_probability:.2f}%")
    print()
    print(f"Race : {RACE_LABELS[race_index]}")
    print(f"Probability : {race_probability:.2f}%")
    print()
...
def main():
    ...
    # Save Figure
    output_path = RESULT_DIR / (Path(image_path).stem + "_prediction.png")
