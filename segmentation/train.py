...
def build_sam_dataset():
    ...
    if not processed_dataset_exists():
        ...
        import preproccess_dataset

        preproccess_dataset.main()
...
def build_fairface_dataset():
    ...
    train_dataset = FairFaceDataset(train_data,encoder_name="clip")

    validation_dataset = FairFaceDataset(validation_data,encoder_name="clip")
