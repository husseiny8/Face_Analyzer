...
class Trainer:
    ...
    def train_epoch(self, train_loader):
        ...
        for batch in progress:
            ...
            gender_correct += (
                ...
                gender_prediction == gender_labels
    ...
    def fit(
        ...
        for epoch in range(epochs):
            ...
            self.history["gender_loss"].append(

                validation_result["gender_loss"]

            )

            self.history["age_loss"].append(

                validation_result["age_loss"]

            )

            self.history["race_loss"].append(

                validation_result["race_loss"]

            )

            self.history["gender_accuracy"].append(

                validation_result["gender_accuracy"]

            )

            self.history["age_accuracy"].append(

                validation_result["age_accuracy"]

            )

            self.history["race_accuracy"].append(

                validation_result["race_accuracy"]
            ...
            print(
                ...
                f"Gender Accuracy : {validation_result['gender_accuracy']:.2f}%"

            )

            print(

                f"Age Accuracy    : {validation_result['age_accuracy']:.2f}%"

            )

            print(

                f"Race Accuracy   : {validation_result['race_accuracy']:.2f}%"
        ...
        history.to_csv(
            ...
            self.checkpoint_dir / "history.csv",
